          ...
          child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //name field
                  SizedBox(height: Editing ? height * 0.02 : height * 0.04),
                  // TextFormField(
                  //   maxLength: 20,
                  //   enabled: Editing,
                  //   textAlign: TextAlign.right,
...
//         .where((document) =>
//             (document.data() as Map<String, dynamic>)['OwnerID'] ==
...
//           .get()
//           .then((snapshot) async {
//         List<DocumentSnapshot> dashAllDocs = snapshot.docs;
//         List<DocumentSnapshot> dashFilteredDocs = dashAllDocs
//             .where((document) =>
//                 (document.data() as Map<String, dynamic>)['dashboardID'] ==
//                 ds['dashboardID'])
//             .toList();
//         for (DocumentSnapshot dashDs in dashFilteredDocs) {
//           //delete dashboard_readings
//           await FirebaseFirestore.instance
//               .collection('dashboard')
//               .doc(dashDs['dashboardID'])
//               .collection('dashboard_readings')
//               .get()
//               .then((snapshot) {
//             for (DocumentSnapshot dashDs in snapshot.docs) {
//               dashDs.reference.delete();
//             }
//           });
...
//           dashDs.reference.delete().then((_) {
...
//     showToast('valid', 'تم حذف حسابك بنجاح');
...
Future<void> UpdateDB() async {
  ...
  var EditInfo = FirebaseFirestore.instance
      .collection('userAccount')
      .doc(FirebaseAuth.instance.currentUser!.uid);
  EditInfo.update({
