          ...
          onPressed: () {
            showDialog(
                ...
                builder: (ctx) => AlertDialog(
                  title: const Text(
                    "الغاء الاشتراك من الحساب",
                    textAlign: TextAlign.left,
                  ),
                  content: const Text(
                    "هل أنت متأكد من الغاء الاشتراك في حساب المنزل ؟",
                    textAlign: TextAlign.left,
                  ),
                  actions: <Widget>[
                    TextButton(
                ...
                .doc(dataList[index][2]["memberID"]) //user id
                .delete()
                .then((_) {
              print("success!, member deleted");
                      ...
                      child: Container(
                        padding: const EdgeInsets.all(14),
                        child: const Text("الغاء الاشتراك",
                            style: TextStyle(
